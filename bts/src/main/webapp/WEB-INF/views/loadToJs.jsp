...
<script>
	$(document).ready(function() {
        ...
        var startLoc = $('.form1').attr('id');
        var endLoc = "잠실종합운동장";
        
        $('#origin').val(startLoc);
        $('#destination').val(endLoc);
...
<body>
	<div class="w3-hide form1" id="${DATA.startLoc}"></div>
	...
	<div id ="homeBtn" class="w3-center w3-col mgb20 w3-orange w3-button" style="height:40px;">홈으로 돌아가기</div>
		...
		<form id="searchForm">
		    <input type="text" id="origin" placeholder="출발지를 입력하세요" class="mgb10 w3-col w3-light-gray" disabled>
		    <input type="text" id="destination" placeholder="도착지를 입력하세요" class="mgb20 w3-col w3-light-gray" disabled>
		</form>
		</div>
